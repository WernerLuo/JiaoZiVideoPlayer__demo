...
public class ActivityApiCustomMediaPlayer extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String source1 = "rtsp://192.168.1.254/xxx.mov";
        String source2 = "http://9890.vod.myqcloud.com/9890_4e292f9a3dd011e6b4078980237cc3d3.f20.mp4";

        jzvdStd.setUp(source1, " ", JzvdStd.SCREEN_WINDOW_NORMAL);
